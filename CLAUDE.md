...
- Messaging: `message`, `typing:start` / `typing:pause` / `typing:stop` (3-state typing indicator — see below), `presence`, `delivered`, `read`, `messageEdited`, `messageDeletedForEveryone`, `reactionUpdate`, `conversationActivity`
